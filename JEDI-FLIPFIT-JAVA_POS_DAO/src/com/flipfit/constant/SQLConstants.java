...
public class SQLConstants {
    ...
    public static final String INSERT_ADMIN = "INSERT INTO ADMIN (adminId, name, email, userId) VALUES (?, ?, ?, ?)";
    ...
    public static final String INSERT_GYM_OWNER = "INSERT INTO GymOwner (ownerId, name, email, phoneNumber, panCard, gstNumber, status) VALUES (?, ?, ?, ?, ?, ?, ?)";
